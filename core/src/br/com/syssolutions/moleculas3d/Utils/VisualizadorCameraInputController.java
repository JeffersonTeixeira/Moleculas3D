...
//
//
////Myself copy of class Camera InputController
//public class VisualizadorCameraInputController extends GestureDetector {
//
//    public static boolean longpressActive;
...
//        public VisualizadorCameraInputController controller;
...
//            System.out.println(controller.longpressActive);
//            Gdx.input.vibrate(100);
//            //  controller.camera.translate(1,0,0);
...
//
//    protected VisualizadorCameraInputController(final CameraGestureListener gestureListener, final Camera camera) {
//        super(gestureListener);
//        this.gestureListener = gestureListener;
//        this.gestureListener.controller = this;
//        this.camera = camera;
//        setLongPressSeconds(0.7f);
//    }
//
//    public VisualizadorCameraInputController(final Camera camera) {
...
//        System.out.println(longpressActive);
//        touched &= -1 ^ (1 << pointer);
//        multiTouch = !MathUtils.isPowerOfTwo(touched);
